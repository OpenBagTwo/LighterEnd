...
Lighter End introduces **nine** new End biomes. These biomes will generate
whether using Lighter End alone (in which case vanilla terrain generation
will be used) or with other End [noise](https://minecraft.wiki/w/Noise_settings)-providing
mods / datapacks such as [Nullscape](https://modrinth.com/datapack/nullscape) and
[Stellarity](https://modrinth.com/datapack/stellarity).

You can also disable Lighter End biomes in the config, accessed either through
[ModMenu](https://modrinth.com/mod/modmenu) or by editing `config/lighterend.yaml`
in your Minecraft folder and setting the line:
```yaml
...
The Glowing Grasslands are the most common Lighter End biome and are composed
of gentle plains with sparse vegegation. [Glossy Mooshrooms](Mobs/glossy_mooshroom)
and [Dragonflies](Mobs/dragonfly) can be found here, and this biome is otherwise
peaceful.
...
Umbra Valleys are perhaps the most hazardous biome in the mod, with nowhere to hide from the
...
and the occasional [Endermite](https://minecraft.wiki/w/Endermite).
...
--- [Edit this page on GitHub](https://github.com/OpenBagTwo/LighterEnd/edit/wiki/content/biomes.md)
