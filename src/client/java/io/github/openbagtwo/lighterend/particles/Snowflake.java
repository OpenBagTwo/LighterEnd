...
public class Snowflake extends SingleQuadParticle {
  ...
  protected Snowflake(
    ...
    this.quadSize = Mth.nextFloat(random, 0.05F, 0.2F);
    this.setAlpha(0F);
  ...
  public static class Factory implements ParticleProvider<SimpleParticleType> {
    ...
    public Particle createParticle(
      ...
      return new Snowflake(world, x, y, z, this.sprites.get(random));
    }
  }
