...
public class LighterEndConfiguredFeatures {
  ...
  public static void initialize() {
    Registry.register(
        ...
        Lumecorn.LumecornFeature.CODEC
    );
    Registry.register(
        BuiltInRegistries.FEATURE_TYPE,
        LighterEnd.of("purple_poplypores"),
        PurplePolypores.CODEC
    );
    Registry.register(
        BuiltInRegistries.FEATURE_TYPE,
        LighterEnd.of("end_lotus"),
        EndLotus.EndLotusFeature.CODEC
    );
    Registry.register(
        BuiltInRegistries.FEATURE_TYPE,
    ...
    Registry.register(
        ...
        SilkMothNest.SilkMothNestFeature.CODEC
    );
    Registry.register(
        BuiltInRegistries.FEATURE_TYPE,
    ...
    Registry.register(
        BuiltInRegistries.FEATURE_TYPE,
        LighterEnd.of("agave"),
        Agave.AgaveFeature.CODEC
    );
    Registry.register(
        BuiltInRegistries.FEATURE_TYPE,
        LighterEnd.of("end_lily"),
        EndLily.EndLilyFeature.CODEC
    );
    Registry.register(
        BuiltInRegistries.FEATURE_TYPE,
