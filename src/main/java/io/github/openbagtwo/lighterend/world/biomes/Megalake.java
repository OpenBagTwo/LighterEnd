...
public class Megalake {
  ...
  public static Biome create(BootstrapContext<Biome> context) {
    ...
    return new Biome.BiomeBuilder()
        ...
        .setAttribute(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(0xB2D1F8))
        .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(0x60A3FF))
        .setAttribute(
