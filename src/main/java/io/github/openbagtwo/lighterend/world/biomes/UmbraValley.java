...
public class UmbraValley {
  ...
  public static Biome create(BootstrapContext<Biome> context) {
    ...
    return new Biome.BiomeBuilder()
        ...
        .setAttribute(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(0x646464))
        .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(0x45C286))
        .setAttribute(
